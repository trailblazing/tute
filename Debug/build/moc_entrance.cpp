...
QT_MOC_LITERAL(17, 177, 21), // "new_dockedwindow_view"
QT_MOC_LITERAL(18, 199, 8), // "WebView*"
QT_MOC_LITERAL(19, 208, 3), // "url"
QT_MOC_LITERAL(20, 212, 16), // "new_dockedwindow"
QT_MOC_LITERAL(21, 229, 33), // "std::pair<DockedWindow*,WebVi..."
QT_MOC_LITERAL(22, 263, 13), // "DockedWindow*"
QT_MOC_LITERAL(23, 277, 5), // "state"
QT_MOC_LITERAL(24, 283, 7), // "prepend"
QT_MOC_LITERAL(25, 291, 9), // "Entrance*"
QT_MOC_LITERAL(26, 301, 7) // "openUrl"
    ...
    "setupActions\0new_dockedwindow_view\0"
    "WebView*\0url\0new_dockedwindow\0"
    "std::pair<DockedWindow*,WebView*>\0"
    "DockedWindow*\0state\0prepend\0Entrance*\0"
    "openUrl"
};
...
static const uint qt_meta_data_browser__Entrance[] = {
 ...
 // slots: parameters
    ...
    0x80000000 | 15,
    QMetaType::Void,
    0x80000000 | 18, QMetaType::QUrl,   19,
    0x80000000 | 21, QMetaType::QUrl,   19,
    0x80000000 | 22, QMetaType::QByteArray,   23,
    0x80000000 | 25, 0x80000000 | 22,    2,
...
void browser::Entrance::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 7: { WebView* _r = _t->new_dockedwindow_view((*reinterpret_cast< const QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< WebView**>(_a[0]) = _r; }  break;
        case 8: { std::pair<DockedWindow*,WebView*> _r = _t->new_dockedwindow((*reinterpret_cast< const QUrl(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< std::pair<DockedWindow*,WebView*>*>(_a[0]) = _r; }  break;
        case 9: { DockedWindow* _r = _t->new_dockedwindow((*reinterpret_cast< const QByteArray(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< DockedWindow**>(_a[0]) = _r; }  break;
        case 10: { Entrance* _r = _t->prepend((*reinterpret_cast< DockedWindow*(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< Entrance**>(_a[0]) = _r; }  break;
        case 11: _t->openUrl((*reinterpret_cast< const QUrl(*)>(_a[1]))); break;
        default: ;
        }
