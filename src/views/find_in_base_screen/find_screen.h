...
signals:
    ...
    boost::intrusive_ptr<i_t>& find_recursive(boost::intrusive_ptr<i_t>& final_result, boost::intrusive_ptr<i_t> _session_root_item, boost::intrusive_ptr<i_t> curritem);
