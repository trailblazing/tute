...
public:
    rs_t(ts_t* _tree_screen, FindScreen* _find_screen, EditorDock* editor_dock, EditingWindow* editing_window, browser::BrowserDock* browser_dock, HidableTabWidget* _vtab_record, const QString& _style_source, browser::Profile* _profile);
