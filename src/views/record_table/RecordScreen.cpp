...
// if(tree_index) {
            _tree_screen->tree_view()->view_paste_children_from_children(TreeIndex::instance(_tree_source_model, _tree_screen->tree_view()->current_item()->parent(), _tree_screen->tree_view()->current_item()), _blank_header, [&] (boost::intrusive_ptr<const Linker> target, boost::intrusive_ptr<const Linker> source) -> bool {
