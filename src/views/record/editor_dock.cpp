...
EditorDock::EditorDock(QString object_name, ts_t *tree_screen, FindScreen *find_screen // browser::ToolbarSearch *toolbarsearch
                      , HidableTab *vtab_record, browser::BrowserDock *browser_dock, wn_t *main_window, const QString &style_source, browser::Profile *profile, Qt::WindowFlags flags)
	: QDockWidget(main_window, flags) // , _application(application)
	  ...
	  , _super_menu([&]() -> SuperMenu * {_super_menu = nullptr; auto sm = new SuperMenu(find_screen, this, vtab_record); return sm;} ()){
	// , _splitter(_splitter)
