...
QMap<Qt::CheckState, QString> char_from_check_state{
    { Qt::CheckState::Checked, QChar(0x221A) }, // for √ // QChar(0x2705)//for✅	// QChar(0x2713)//QChar(0x2611) // QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"   //QChar(0xfb)
    { Qt::CheckState::Unchecked, "" }
};

QMap<QString, Qt::CheckState> check_state_from_char{
    { QChar(0x221A), Qt::CheckState::Checked }, // for √ // QChQChar(0x221A)//for✅// ar(0x2705)	// QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"    //QChar(0xfb)
    { "", Qt::CheckState::Unchecked }
};

QMap<bool, QString> char_from_bool{
    { true, QChar(0x221A) }, // for √ // QChar(0x2705)//for✅	// QChar(0x2713)//QChar(0x2611) // QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"   //QChar(0xfb)
    { false, "" }
};

QMap<QString, bool> bool_from_char{
    { QChar(0x221A), true }, // for √ // QChar(0x2705)//for✅	// QChar(0x2713)//QChar(0x2611) // QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"   //QChar(0xfb)
    { "", false }
};

QMap<Qt::CheckState, bool> bool_from_check_state{
    { Qt::CheckState::Checked, true }, // for √ // QChar(0x2705)//for✅	// QChar(0x2713)//QChar(0x2611) // QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"   //QChar(0xfb)
    { Qt::CheckState::Unchecked, false }
};

QMap<bool, Qt::CheckState> check_state_from_bool{
    { true, Qt::CheckState::Checked }, // for √ // QChQChar(0x221A)//for✅// ar(0x2705)	// QChar(Qt::UNICODE_ACCEL + 2713) // QChar(Qt::ALT + 251)  //  "v"    //QChar(0xfb)
...
{
    if (name == "pin" || name == "name" || name == "author" || name == "home" || name == "url" || name == "tags")
        return true;
    else
        return false;
}
