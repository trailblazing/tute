...
public:
    Editentry(QString object_name, ts_t* tree_screen, FindScreen* _find_screen, browser::Entrance* entrance, wn_t* main_window, AppConfig& appconfig, const QString& style_source, browser::Profile* profile, Qt::WindowFlags flags = 0);
    ~Editentry();
