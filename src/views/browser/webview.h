...
private slots:
        ...
        void proxyAuthenticationRequired(const QUrl &requestUrl, QAuthenticator *auth,
...
//        WebView *bind(boost::intrusive_ptr<TreeItem> item);
        ...
        item() const;           // {return _record_binder->bounded_item();}
        WebPage *page() const;
...
private:
            ...
            //            bool _make_current;
public:
            Binder(boost::intrusive_ptr<TreeItem> item_, WebPage *page_);                     // , bool make_current = true
