...
namespace browser {
    ...
    public:
        ...
        typedef CouplerDelegation                      bounded_page_helper;
        ...
        private:
            ...
            //            bool _make_current;
        public:
            Coupler(WebPage *_page)  // , bool make_current = true
        ...
        boost::intrusive_ptr<TreeItem> item_equip_registered(boost::intrusive_ptr<TreeItem> it);
