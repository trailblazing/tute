...
//    }
	...
	if(title.isEmpty()) setWindowTitle(tr(globalparameters.application_name().toStdString().c_str()));
	else{
#if defined(Q_OS_OSX)
	    setWindowTitle(title);
#else
	    setWindowTitle(tr(QString(QString("%1 - ") + globalparameters.application_name()).toStdString().c_str()
