...
void SettingsDialog::loadFromSettings()
{
    ...
    zoomFactor->setText(qvariant_cast<QString>(settings.value(QLatin1String("zoomFactor"), _zoomFactor)));
    standardLabel->setText(QString(QLatin1String("%1 %2")).arg(standardFont.family()).arg(standardFont.pointSize()));
    fixedLabel->setText(QString(QLatin1String("%1 %2")).arg(fixedFont.family()).arg(fixedFont.pointSize()));
...
void SettingsDialog::saveToSettings()
{
    ...
    settings.setValue(QLatin1String("zoomFactor"), zoomFactor->text());
...
void SettingsDialog::setZoomFactor()
{
    Browser* mw = static_cast<Browser*>(parent());
    WebView* webView = mw->currentTab();
    if (webView)
        webView->setZoomFactor(qvariant_cast<qreal>(zoomFactor->text()));
}
