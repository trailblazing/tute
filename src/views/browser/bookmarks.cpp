...
RemoveBookmarksCommand::RemoveBookmarksCommand(
    BookmarksManager *bookmarkManagaer, BookmarkNode *parent, int row)
...
InsertBookmarksCommand::InsertBookmarksCommand(
    BookmarksManager *bookmarkManagaer, BookmarkNode *parent,
...
bool AddBookmarkProxyModel::filterAcceptsRow(
