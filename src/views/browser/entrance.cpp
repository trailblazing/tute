...
namespace browser {
    ...
    void Entrance::setup_signals(browser::ToolbarSearch *toolbarsearch)
    {
        ...
        void(Entrance::*_activate)(const QUrl &, std::function<boost::intrusive_ptr<TreeItem> (std::function<KnowModel *()>, QModelIndex, boost::intrusive_ptr<TreeItem>)>, equal_url_t) = &Entrance::activate;  // <url_fragment>;
