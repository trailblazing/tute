...
Entrance::Entrance(QString object_name, ts_t* _tree_screen, FindScreen* _find_screen // browser::ToolbarSearch *toolbarsearch
    //		      , Editentry *_editentry
    ,
    wn_t* _main_window, AppConfig& _appconfig, const QString& style_source, browser::Profile* _profile, Qt::WindowFlags flags)
...
void Entrance::resizeEvent(QResizeEvent* e)
{
    ...
    // }
    if (this->widget())
        static_cast<Browser*>(this->widget())->resizeEvent(e);
