    ...
    , _removepolicy(Never)
{
    ...
    if (globalparameters.download_manager() != this)
        globalparameters.download_manager(this);
    load();
}
...
DownloadManager::~DownloadManager()
{
    ...
    if (globalparameters.download_manager() == this)
        globalparameters.download_manager(nullptr);
}
...
void DownloadManager::updateRow()
{
    ...
    if (!widget->downloading()
        && sapp_t::instance()->privateBrowsing())
        remove = true;
