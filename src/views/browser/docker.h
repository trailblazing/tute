...
public:
    Docker(QString object_name, wn_t* main_window // , std::shared_ptr<AppConfig> appconfig_
        ,
...
public:
    DockerImpl(QString object_name, wn_t* main_window // , std::shared_ptr<AppConfig> appconfig_
        ,
        Qt::WindowFlags flags = 0)
