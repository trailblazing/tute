...
class KnowView : public QTreeView {
    ...
    public slots:
        ...
        boost::intrusive_ptr<TreeItem> view_paste_sibling(boost::intrusive_ptr<TreeIndex> _treeindex, boost::intrusive_ptr<TreeItem> _source_item, const substitute_condition &_substitute_condition);
        ...
        void view_edit(void);
        boost::intrusive_ptr<TreeItem> view_merge(boost::intrusive_ptr<TreeIndex> tree_index, boost::intrusive_ptr<TreeItem> source);
