...
QMenu *TreeScreen::menus_in_button(){
...
// |__sub menu 0  [QMenu *]
// |__sub menu 1  [QMenu *]
void TreeScreen::assembly_menubar(QMenu *_filemenu, QMenu *_toolsmenu){
    // _menubar->hide();
...
// {
// _main_menu_button->setMenu(_main_menu_in_button);                                                            // Ownership of the menu is not transferred to the push button
////_menuaction
...
// _main_menu_action->setDefaultWidget(_main_menu_button);                                                         // The ownership is transferred to QWidgetAction!!!  //_menubar////_buttonmenu//


// _main_menu_button->setIcon(QIcon(":/resource/pic/tableware.svg"));                                                            // must have
...
// QList<QStringList> cryptFlagsList = it->path_children_all_as_field(boost::mpl::c_str < crypt_type > ::value);
