...
public:
    ...
    typedef std::function<boost::intrusive_ptr<i_t>(TreeIndex, boost::intrusive_ptr<i_t>, const substitute_condition&)> paste_strategy;

    ts_t(QString object_name, web::Docker* editor_docker_, wn_t* main_window = 0);
    virtual ~ts_t();
...
private slots:
    ...
    // void edit_field(QString pin, QString name, QString author, QString home, QString url, QString tags);
