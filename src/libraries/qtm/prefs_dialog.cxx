...
{
    QString dir = QFileDialog::getExistingDirectory(0, tr("Choose a directory"), "/home");
    if (!dir.isEmpty())
        leLocalDir->setText(dir);
}

void PrefsDialog::on_pbWhatsThis_clicked()
{ // slot
...
void PrefsDialog::on_tbEditorBgColor_clicked()
{ // slot
...
void PrefsDialog::on_tbEditorFgColor_clicked()
{ // slot
    QPalette palette = lEditorExampleText->palette();
...
void PrefsDialog::on_tbPreviewBgColor_clicked()
{ // slot
...
void PrefsDialog::on_tbPreviewFgColor_clicked()
{ // slot
    QPalette palette = lPreviewExampleText->palette();
    QColor color = QColorDialog::getColor(palette.color(QPalette::WindowText), this);
    if (color.isValid()) {
...
void PrefsDialog::on_tbConsoleBgColor_clicked()
{ // slot
...
void PrefsDialog::on_tbConsoleFgColor_clicked()
{ // slot
    QPalette palette = lConsoleExampleText->palette();
    QColor color = QColorDialog::getColor(palette.color(QPalette::WindowText), this);
    if (color.isValid()) {
