...
SideTabWidget::SideTabWidget(ts_t *_tree_screen
			    ...
			    , QSplitter *splitter
			    , QWidget *parent) : HidableTabWidget(_tree_screen
								     , _find_screen
								     , _editentry
								     , _entrance
								     , _main_window
								     ...
								     , style_source_
								     , splitter
								     , std::make_shared<QSettings>(globalparameters.root_path() + "/" + globalparameters.target_os() + "/" + gl_para::_editor_conf_filename, QSettings::IniFormat)
								     , "geometry"
								     , "splitter_sizelist"
								     , "collapsed"
								     , parent){
...
//    QWidget *this = this;
	if(this->objectName().isEmpty()) this->setObjectName(QStringLiteral("CategoryWidget"));
