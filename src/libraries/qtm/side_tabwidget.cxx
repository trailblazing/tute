...
{
	// , tabWidget(new HidableTabWidget(_tree_screen, _find_screen, _editentry,
	// _entrance, _main_window, _profile, style_source_, this))
	setupUi();
	connect(_lineedit_topic, &QLineEdit::returnPressed, [&]() {if(""!=_lineedit_topic->text()) _blogger->on_topic_changed(_lineedit_topic->text()); });
}
...
void SideTabWidget::setupUi()
{
	...
	[&] {
		...
		horizontalSpacer =
		    new QSpacerItem(56, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
		...
		horizontalSpacer_2 =
		    new QSpacerItem(55, 20, QSizePolicy::Expanding, QSizePolicy::Minimum);
		...
		sizeP_policy_topic_label.setHeightForWidth(
		    _label_topic->sizePolicy().hasHeightForWidth());
		...
		auto tips = "Edit me and Enter to change topic name";
		_lineedit_topic->setToolTip(tips);
		_lineedit_topic->setStatusTip(tips);
		_lineedit_topic->setWhatsThis(tips);
...
void SideTabWidget::retranslateUi()
{
	...
	// );
	cbStatus->clear();
	cbStatus->insertItems(
	    0,
	    QStringList() << QApplication::translate("CategoryWidget", "Draft", 0)
			  << QApplication::translate("CategoryWidget", "Publish", 0));
#ifndef QT_NO_WHATSTHIS
	cbStatus->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Whether the entry is to be published immediately, or "
	    "just stored in the blog database for publication "
	    "later",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_WHATSTHIS
	lStatus->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Whether the entry is to be published immediately, or "
	    "stored in the blog database for publication later",
	    0));
#endif // QT_NO_WHATSTHIS
	lStatus->setText(QApplication::translate("CategoryWidget", "&Status", 0));
	lStatus->setBuddy(cbStatus);
#ifndef QT_NO_WHATSTHIS
	cbBlogSelector->setWhatsThis(QApplication::translate("CategoryWidget",
	    "If your blog software allows you to publish more than "
	    "one blog, as with Movable Type, you must choose which "
	    "blog here.  (If you use Wordpress, ignore this.)",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_WHATSTHIS
	lePassword->setWhatsThis(QApplication::translate("CategoryWidget",
	    "A password to read this post. Leave this blank if you "
	    "do not want to apply a password. Note that the title "
	    "will be visible.",
	    0));
#endif // QT_NO_WHATSTHIS
	...
	// lTitle->setText(QApplication::translate("CategoryWidget", "Entry
	// &amp;title", 0).toLatin1());
	lTitle->setText(QApplication::translate("CategoryWidget", "Entry &title", 0));
	lTitle->setBuddy(leTitle);
	// lTitle->setWindowTitle(QApplication::translate("CategoryWidget", "Entry
	// &title", 0));
	...
	chShowPassword->setText(
	    QApplication::translate("CategoryWidget", "Show passwor&d", 0));
	_label_topic->setText(
	    QApplication::translate("CategoryWidget", "Entry &Topic", 0));
	_label_topic->setBuddy(_lineedit_topic);
	label->setText(
	    QApplication::translate("CategoryWidget", "<b>Feedback</b>", 0));
#ifndef QT_NO_WHATSTHIS
	chAllowComments->setWhatsThis(QApplication::translate("CategoryWidget", "Click here if comments are to be allowed", 0));
#endif // QT_NO_WHATSTHIS
	chAllowComments->setText(
	    QApplication::translate("CategoryWidget", "Comments", 0));
#ifndef QT_NO_WHATSTHIS
	chAllowTB->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Trackbacks are links to other sites, or other people's blog entries, "
	    "placed by other people.  If you want to allow this, tick this box. Note "
	    "that if you configure your blog software to refuse trackbacks, or not "
	    "publish trackback locations, ticking this box will have no effect.",
	    0));
#endif // QT_NO_WHATSTHIS
	chAllowTB->setText(QApplication::translate("CategoryWidget", "Trackback", 0));
#ifndef QT_NO_WHATSTHIS
	chSticky->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Sticky posts will always appear at the top of your "
	    "Wordpress blog, usually in a distinctive style.",
	    0));
#endif // QT_NO_WHATSTHIS
	chSticky->setText(
	    QApplication::translate("CategoryWidget", "Make this post stick&y", 0));
	cbDoTB->setText(
	    QApplication::translate("CategoryWidget", "Trackback this entry", 0));
#ifndef QT_NO_TOOLTIP
	pbCopyURL->setToolTip(QApplication::translate("CategoryWidget", "Copy the uploaded file's URL to the clipboard", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	pbCopyURL->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Copy the location of the file you just uploaded to "
	    "the clipboard, so you can paste it into your entry",
	    0));
#endif // QT_NO_WHATSTHIS
	pbCopyURL->setText(QApplication::translate("CategoryWidget", "Copy URL", 0));
	lProgressBarLabel->setText(
	    QApplication::translate("CategoryWidget", "Uploading:", 0));
	this->setTabText(this->indexOf(_basics), _basics->objectName());
	gbCategory->setTitle(
	    QApplication::translate("CategoryWidget", "Categories", 0));
	lMainCat->setText(QApplication::translate("CategoryWidget", "Primary", 0));
#ifndef QT_NO_WHATSTHIS
	cbMainCat->setWhatsThis(QApplication::translate("CategoryWidget",
	    "The main category under which your entry is to be "
	    "published.  If you are choosing only one category, "
	    "choose it here.",
	    0));
#endif // QT_NO_WHATSTHIS
	lOtherCats->setText(QApplication::translate("CategoryWidget", "Others", 0));
#ifndef QT_NO_WHATSTHIS
	lwOtherCats->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Secondary categories, if your blog system supports "
	    "them.  To select more than one category, hold down "
	    "Ctrl and click the main mouse button.",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_TOOLTIP
	chNoCats->setToolTip(
	    QApplication::translate("CategoryWidget", "Don't use any categories", 0));
#endif // QT_NO_TOOLTIP
	chNoCats->setText(
	    QApplication::translate("CategoryWidget", "No categories", 0));
#ifndef QT_NO_WHATSTHIS
...
#ifndef QT_NO_TOOLTIP
	pbAddCategory->setToolTip(
	    QApplication::translate("CategoryWidget", "Add a category", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	pbAddCategory->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Add a new category to your blog.  Your blog needs to "
	    "support the Wordpress API for this to work.",
	    0));
#endif // QT_NO_WHATSTHIS
	pbAddCategory->setText(
	    QApplication::translate("CategoryWidget", "Add category", 0));
	this->setTabText(this->indexOf(_categories), _categories->objectName());
	gbExcerpt->setTitle(
	    QApplication::translate("CategoryWidget", "RSS Excerpt", 0));
	lExcerptExplanation->setText(QApplication::translate("CategoryWidget",
	    "RSS E&xcerpt: This will appear in your summarised RSS "
	    "feeds if you choose to enter anything here.  If you "
	    "do not, your blog engine will use the first few lines "
	    "of the post (or the entire post, if it is short "
	    "enough).",
	    0));
	this->setTabText(this->indexOf(_excerpt), _excerpt->objectName());
	gbKeywordTags->setTitle(
	    QApplication::translate("CategoryWidget", "Wordpress-style tags", 0));
#ifndef QT_NO_TOOLTIP
	leAddKeywordTag->setToolTip(QApplication::translate("CategoryWidget", "Enter tag; no need for quotes", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	leAddKeywordTag->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Enter the tag name here; no need to use quotes if "
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	lwAvailKeywordTags->setWhatsThis(QApplication::translate("CategoryWidget",
	    "These are the tags that your blog already knows "
	    "about. Double-click any of these to add it to this "
	    "entry. You can add another one using the line box "
	    "below.",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_TOOLTIP
...
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	lwKeywordTags->setWhatsThis(QApplication::translate("CategoryWidget",
	    "These are the tags used in Wordpress (known as "
	    "keywords in Movable Type and TypePad)",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_TOOLTIP
	tbAddKeywordTag->setToolTip(
	    QApplication::translate("CategoryWidget", "Add tag", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
	tbAddKeywordTag->setWhatsThis(QApplication::translate("CategoryWidget", "Click here to add the tag to the list", 0));
#endif // QT_NO_WHATSTHIS
	tbAddKeywordTag->setText(
	    QApplication::translate("CategoryWidget", "&Add", 0));
	tbSelectKeywordTag->setText(QString());
	tbRemoveKeywordTag->setText(QString());
	pbRefreshKeywordTags->setText(
	    QApplication::translate("CategoryWidget", "Refresh", 0));
	this->setTabText(this->indexOf(_wp_tags), _wp_tags->objectName());
	gbTags->setTitle(
	    QApplication::translate("CategoryWidget", "Technorati tags", 0));
#ifndef QT_NO_WHATSTHIS
	leAddTag->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Enter a new Technorati tag here; use the Technorati "
	    "format which uses plus signs, not spaces, to separate",
	    0));
#endif // QT_NO_WHATSTHIS
#ifndef QT_NO_TOOLTIP
	tbAddTag->setToolTip(
	    QApplication::translate("CategoryWidget", "Add this tag", 0));
#endif // QT_NO_TOOLTIP
#ifndef QT_NO_WHATSTHIS
...
#endif // QT_NO_WHATSTHIS
	gbTagPlace->setTitle(
	    QApplication::translate("CategoryWidget", "Position of tags", 0));
#ifndef QT_NO_WHATSTHIS
	rbStartOfMainEntry->setWhatsThis(QApplication::translate("CategoryWidget", "Place the tags at the start of the entry", 0));
#endif // QT_NO_WHATSTHIS
	rbStartOfMainEntry->setText(
	    QApplication::translate("CategoryWidget", "Start of main entry", 0));
#ifndef QT_NO_WHATSTHIS
	rbEndOfMainEntry->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Place the tags at the end of the main entry, which "
	    "means before the More tag if there is one",
	    0));
#endif // QT_NO_WHATSTHIS
	rbEndOfMainEntry->setText(
	    QApplication::translate("CategoryWidget", "End of main entry", 0));
	this->setTabText(this->indexOf(_technorati_tags), _technorati_tags->objectName());
	gbTrackbacks->setTitle(
	    QApplication::translate("CategoryWidget", "Trackback pings", 0));
#ifndef QT_NO_WHATSTHIS
	lwTBPings->setWhatsThis(QApplication::translate("CategoryWidget",
	    "Locations of web articles (usually blog entries) you "
	    "want to trackback when posting this entry.",
	    0));
#endif // QT_NO_WHATSTHIS
	...
	////
	// QSettings qtm_settings(globalparameters.root_path() + "/" +
	// globalparameters.target_os() + "/" +
	// globalparameters._editor_conf_filename, QSettings::IniFormat);

	// QStringList line_list;
	// QList<int>	list;
	// qtm_settings.beginGroup("geometry");
	// line_list = (qtm_settings.value("splitter_sizelist",
	...
	// if(list[0] <= this->tabBar()->sizeHint().width())
	// HidableTabWidget::collapse_when_true(true);
	// else{
	// this->resize(list[0], parentWidget()->geometry().height());	//
	// parentWidget()->geometry().width() * 38 / 100	// 284
	//// 428
	// }
}

void SideTabWidget::title(const QString& title_)
{
	leTitle->setText(title_);
}

QString SideTabWidget::title() const
{
	return leTitle->text();
}
...
{
	return _lineedit_topic->text();
}

QLineEdit* SideTabWidget::lineedit_topic()
{
