...
public:
    ...
    /*  Catkin( QList<QString>, QList<QString>, int,
	   QWidget *parent = 0 );*/
    EditingWindow(ts_t* tree_screen, browser::BrowserDock* browser_dock, HidableTabWidget* vtab_record, browser::Profile* profile, FindScreen* find_screen, EditorDock* editor_dock, QString style_source_, QStringList hide_editor_tools_ = appconfig->hide_editor_tools(), QString new_post_topic = "undefined" // global_root_id// get_unical_id()
        ,
