...
SuperMenu::SuperMenu(FindScreen *_find_screen, EditorDock *editentry, HidableTabWidget *vtab_record, QWidget *parent, SysTrayIcon *sti)
	: super(parent)
	  , _sti(sti)
...
// qDebug( "setting fonts" );
		...
		if(!qd.exists())
			if(!qd.mkpath(localStorageDirectory)) QMessageBox::information(0, tr("Warning"), tr("Could not create QTM directory."), QMessageBox::Cancel);
