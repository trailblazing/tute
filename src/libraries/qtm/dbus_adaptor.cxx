...
/** getQuickpostTemplateTitles: Returns a string list of the titles of available
 * quickpost templates
 *  in format n.[title]
 */
...
/** getQuickpostTemplates: Returns a string list of the titles and content of
 * available quickpost templates
...
/** quickpost - Does a quickpost.  The web location of the quickposted document
 * is the first argument
 *  and the content is the second.
 *  Note that if the web location is associated with a particular template, that
 * template will be
 *  used.
 */
...
/** quickpostFromLauncher - Does a quickpost, getting the STI object to use the
 * clipboard to
 * determine the location or content. Designed for use with the Launcher on
 * Ubuntu Unity.
 */
