...
void Application::set_recent_files(const QStringList& titles, const QStringList& filenames)
{
    int i;
...
void Application::add_recent_file(const QString& title, const QString& filename)
{
    recentFile thisFile;
    int i;
