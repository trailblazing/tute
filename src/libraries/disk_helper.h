...
class DiskHelper {
	...
	static std::shared_ptr<QFileInfo> copy_file_force(QString source, QString target);
	static std::shared_ptr<QFileInfo>
	recover_ini_file(std::shared_ptr<QFileInfo> target_file, bool force_remove = false);
};
