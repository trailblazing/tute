...
// stackoverflow.com/questions/13308341/qcombobox-abstractitemviewitem
...
class FlatComboBox : public QComboBox {
	...
	Qt::Alignment arrowAlignment() const {
		return arrowAlignment_;
	}
...
class FlatToolButton : public QToolButton {
	...
	W_PROPERTY(bool, autoRaise, &FlatToolButton::autoRaise,
	           &FlatToolButton::setAutoRaise)  //
#else
	...
	FlatToolButton(
	    ...
	    const QIcon &icon = QIcon());  // QIcon (":/resource/pic/trace.svg")
