...
void IndentSlider::mousePressEvent(QMouseEvent* event)
{
    ...
    current_sel_indent = SEL_NONE;
    if (y < (widget_height / 2) && x > (indentline_left_pos + leftindent_pos + textindent_pos - indenttriangle_width / 2) && x < (indentline_left_pos + leftindent_pos + textindent_pos + indenttriangle_width / 2))
