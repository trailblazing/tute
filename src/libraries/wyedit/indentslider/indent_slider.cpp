...
// Определяется, какой движок был выбран
	...
	x < (indentline_left_pos + leftindent_pos + textindent_pos + indenttriangle_width / 2))current_sel_indent = SEL_TEXT_INDENT;
    else if(y > widget_height / 2 &&
	x > indentline_left_pos + leftindent_pos - indenttriangle_width / 2 &&
	x < indentline_left_pos + leftindent_pos + indenttriangle_width / 2)current_sel_indent = SEL_LEFT_INDENT;
    else if(y > widget_height / 2 &&
	x > indentline_right_pos - (rightindent_pos + indenttriangle_width / 2) &&
	x < indentline_right_pos - (rightindent_pos - indenttriangle_width / 2))current_sel_indent = SEL_RIGHT_INDENT;
