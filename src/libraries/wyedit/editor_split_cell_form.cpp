...
EditorSplitCellForm::EditorSplitCellForm(int fixHorisontalSplit, int fixVerticalSplit) {
	...
	checkboxLabelFixHSplit =
	    new QLabel("<b>" + QString::number(fixHSplit) + "</b> ");
	checkboxLabelFixVSplit =
	    new QLabel("<b>" + QString::number(fixVSplit) + "</b> ");
...
EditorSplitCellForm::~EditorSplitCellForm() {
	...
	if (checkboxFixHSplit != nullptr)
		delete checkboxFixHSplit;
	if (checkboxFixVSplit != nullptr)
		delete checkboxFixVSplit;
	if (checkboxLabelFixHSplit != nullptr)
		delete checkboxLabelFixHSplit;
	if (checkboxLabelFixVSplit != nullptr)
		delete checkboxLabelFixVSplit;
	if (labelPictogramH != nullptr)
		delete labelPictogramH;
	if (labelPictogramV != nullptr)
		delete labelPictogramV;
	if (labelH != nullptr)
		delete labelH;
	if (labelV != nullptr)
		delete labelV;
