...
//	_editor_config = std::make_shared<EditorConfig>(_init_data_config_file_name, nullptr);// this
	...
	if(_view_mode == WYEDIT_MOBILE_MODE && !_tools_name_list_in_line_0.contains("back")){
	...
	if(_view_mode == WYEDIT_MOBILE_MODE && !_tools_name_list_in_line_0.contains(action_find_in_base)){
...
//	_find_dialog = std::make_unique<EditorFindDialog>(_editor_config, nullptr);// this
...
void Editor::setup_buttons(void){
	...
	// Кнопка Bold
	_bold
		= add_action(_tools_line_0, this, tr((editor_prefix + "bold").c_str()), tr("Bold (Ctrl+B)"), tr("Bold (Ctrl+B)"), QIcon(":/resource/pic/edit_bold.svg"), [&](bool){on_bold_clicked();}, QKeySequence(QKeySequence::Bold));
	...
	// Кнопка Monospace
	_monospace
		= add_action(_tools_line_0, this, tr((editor_prefix + "monospace").c_str()), tr("Monospace (Ctrl+T)"), tr("Monospace (Ctrl+T)"), QIcon(":/resource/pic/edit_monospace.svg"), [&](bool){on_monospace_clicked();}, QKeySequence(tr("Ctrl+T")));

	// Кнопка Code
	_code
		= add_action(_tools_line_0, this, tr((editor_prefix + "code").c_str()), tr("Code (Ctrl+M). Select a whole paragraphs to format text as code."), tr("Code (Ctrl+M). Select a whole paragraphs to format text as code."), QIcon(":/resource/pic/edit_code.svg"), [&](bool){on_code_clicked();}, QKeySequence(tr("Ctrl+M")));
	// action_Blockquote
	...
	_numeric_list
		= add_action(_tools_line_0, this, tr((editor_prefix + "numericlist").c_str()), tr("Numeric list"), tr("Numeric list"), QIcon(":/resource/pic/edit_listnumeric.svg"), [&](bool){on_numericlist_clicked();});
	...
	_indent_plus
		= add_action(_tools_line_0, this, tr((editor_prefix + "indentplus").c_str()), tr("Increase indent"), tr("Increase indent"), QIcon(":/resource/pic/edit_indentplus.svg"), [&](bool){on_indentplus_clicked();});

	// Кнопка уменьшения отступа
	_indent_minus
		= add_action(_tools_line_0, this, tr((editor_prefix + "indentminus").c_str()), tr("Decrease indent"), tr("Decrease indent"), QIcon(":/resource/pic/edit_indentminus.svg"), [&](bool){on_indentminus_clicked();});

	// Кнопка выравнивания по левому краю
	_align_left
		= add_action(_tools_line_0, this, tr((editor_prefix + "alignleft").c_str()), tr("Align left (Ctrl+L)"), tr("Align left (Ctrl+L)"), QIcon(":/resource/pic/edit_alignleft.svg"), [&](bool){on_alignleft_clicked();}, QKeySequence(tr("Ctrl+L")));

	// Кнопка выравнивания по центру
	_align_center
		= add_action(_tools_line_0, this, tr((editor_prefix + "aligncenter").c_str()), tr("Align center (Ctrl+E)"), tr("Align center (Ctrl+E)"), QIcon(":/resource/pic/edit_aligncenter.svg"), [&](bool){on_aligncenter_clicked();}, QKeySequence(tr("Ctrl+E")));

	// Кнопка выравнивания по правому краю
	_align_right
		= add_action(_tools_line_0, this, tr((editor_prefix + "alignright").c_str()), tr("Align right (Ctrl+R)"), tr("Align right (Ctrl+R)"), QIcon(":/resource/pic/edit_alignright.svg"), [&](bool){on_alignright_clicked();}, QKeySequence(tr("Ctrl+R")));

	// Кнопка выравнивания по ширине
	_align_width
		= add_action(_tools_line_0, this, tr((editor_prefix + "alignwidth").c_str()), tr("Align width (Ctrl+J)"), tr("Align width (Ctrl+J)"), QIcon(":/resource/pic/edit_alignwidth.svg"), [&](bool){on_alignwidth_clicked();}, QKeySequence(tr("Ctrl+J")));
	...
	_expand_tools_lines
		= add_action(_tools_line_0, this, tr((editor_prefix + "expand_tools_lines").c_str()), tr("Expand tools"), tr("Expand tools"), QIcon(":/resource/pic/edit_expand_tools_lines.svg"), [&](bool){on_expand_tools_lines_clicked();});
	...
	_to_attach
		= add_action(_tools_line_0, this, tr((editor_prefix + "attach").c_str()), tr("Show attach files"), tr("Show attach files"), _icon_attach_not_exists, [&](bool){on_to_attach_clicked();});
	...
	_expand_edit_area
		= add_action(_tools_line_0, this, tr((editor_prefix + "expand_edit_area").c_str()), tr("Expand edit area"), tr("Expand edit area"), QIcon(":/resource/pic/edit_expand_text_area.svg"), [&](bool){on_expand_edit_area_clicked();});
	...
	_find_in_base
		= add_action(_tools_line_0, this, tr((editor_prefix + "find_in_base").c_str()), tr("Find in base"), tr("Find in base"), QIcon(":/resource/pic/find_in_base.svg"), [&](bool){on_find_in_base_clicked();});
	// Кнопка вызова виджета поиска текста
	_find_text
		= add_action(_tools_line_0, this, tr((editor_prefix + "findtext").c_str()), tr("Find text (Ctrl+F)"), tr("Find text (Ctrl+F)"), QIcon(":/resource/pic/edit_findtext.svg"), [&](bool){on_findtext_clicked();}, QKeySequence(tr("Ctrl+F")));
	...
	_show_formatting
		= add_action(_tools_line_0, this, tr((editor_prefix + "showformatting").c_str()), tr("Show special chars"), tr("Show special chars"), QIcon(":/resource/pic/edit_showformatting.svg"), [&](bool){on_showformatting_clicked();});

	// Кнопка "показать текст" для просмотра текста в отдельном окне
	_show_text
		= add_action(_tools_line_0, this, tr((editor_prefix + "show_text").c_str()), tr("Show text in detached window"), tr("Show text in detached window"), QIcon(":/resource/pic/edit_show_text.svg"), [&](bool){on_show_text_clicked();});

	//
	// Выбор шрифта
	_font_select
		= add_action(_tools_line_1, this, tr((editor_prefix + "fontselect").c_str()), tr("Select font type"), tr("Select font type"), QIcon(":/resource/pic/edit_font_many.svg"), (FlatFontComboBox *) (nullptr), this, &Editor::on_fontselect_changed);

	// Выбор размера шрифта
	_font_size = add_action(_tools_line_1, this, tr((editor_prefix + "fontsize").c_str()), tr("Select font size"), tr("Select font size"), qobject_cast<sapp_t *>(qApp)->defaultIcon(), (FlatComboBox *) (nullptr), this, &Editor::on_fontsize_changed);
	...
	_create_table
		= add_action(_tools_line_1, this, tr((editor_prefix + "createtable").c_str()), tr("Create a new table"), tr("Create a new table"), QIcon(":/resource/pic/edit_createtable.svg"), [&](bool){on_createtable_clicked();});

	_table_remove_row
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_remove_row").c_str()), tr("Remove row(s)"), tr("Remove row(s)"), QIcon(":/resource/pic/edit_table_remove_row.svg"), [&](bool){on_table_remove_row_clicked();});

	_table_remove_col
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_remove_col").c_str()), tr("Remove column(s)"), tr("Remove column(s)"), QIcon(":/resource/pic/edit_table_remove_col.svg"), [&](bool){on_table_remove_col_clicked();});

	_table_add_row
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_add_row").c_str()), tr("Add row(s)"), tr("Add row(s)"), QIcon(":/resource/pic/edit_table_add_row.svg"), [&](bool){on_table_add_row_clicked();});

	_table_add_col
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_add_col").c_str()), tr("Add column(s)"), tr("Add column(s)"), QIcon(":/resource/pic/edit_table_add_col.svg"), [&](bool){on_table_add_col_clicked();});

	_table_merge_cells
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_merge_cells").c_str()), tr("Merge cells"), tr("Merge cells"), QIcon(":/resource/pic/edit_table_merge_cells.svg"), [&](bool){on_table_merge_cells_clicked();});

	_table_split_cell
		= add_action(_tools_line_1, this, tr((editor_prefix + "table_split_cell").c_str()), tr("Split cell"), tr("Split cell"), QIcon(":/resource/pic/edit_table_split_cell.svg"), [&](bool){on_table_split_cell_clicked();});
...
void Editor::file_name(QString _file_name){
	...
	if(_file_name.size() > 0){
		...
		if(!f.open(QIODevice::WriteOnly | QIODevice::Text | QIODevice::ReadOnly)) critical_error(
				"Editor::file_name(QString _file_name) : Can\'t open text file " + _file_name + " for read / write.");
...
void Editor::editor_save_callback(QObject *editor, const QString &save_text){
	...
	if(work_with_crypt == false){
		...
		QFile wfile(file_name);
		if(!wfile.open(QIODevice::WriteOnly)) critical_error(
				"Editor::editor_save_callback() : Can\'t open binary file " + file_name + " for write.");
...
void Editor::on_clear_clicked(void){
	...
	if(!(_text_area->textCursor().hasSelection() || flag_cursor_on_empty_line || flag_cursor_on_space_line)) return;
	_text_area->textCursor().beginEditBlock();
	...
	if(is_block_select() || flag_cursor_on_empty_line || flag_cursor_on_space_line){
...
void Editor::format_to_list(QTextListFormat::Style setFormat){
	...
	// Если строки выбраны
	if(_text_area->textCursor().hasSelection()){
		if(_text_area->textCursor().currentList() == 0 || _text_area->textCursor().currentList()->format().style() != setFormat){
...
void Editor::on_selection_changed(void){
	...
	while(cursor.position() <= stop){
		if(differentFontFlag == 0 && startFontFamily != cursor.charFormat().fontFamily()) differentFontFlag = 1;
		if(differentSizeFlag == 0 && startSize != cursor.charFormat().fontPointSize()) differentSizeFlag = 1;
		...
		if(differentItalicFlag == 0 && startItalic != cursor.charFormat().fontItalic()) differentItalicFlag = 1;
		if(differentUnderlineFlag == 0 && startUnderline != cursor.charFormat().fontUnderline()) differentUnderlineFlag = 1;
		if(differentAlignFlag == 0 && startAlign != cursor.blockFormat().alignment()) differentAlignFlag = 1;
...
bool Editor::is_key_for_tool_line_update(QKeyEvent *event){
	if(event->modifiers().testFlag(Qt::ControlModifier) || event->modifiers().testFlag(Qt::AltModifier) || event->modifiers().testFlag(Qt::MetaModifier) || event->key() == Qt::Key_F1 || event->key() == Qt::Key_F2 || event->key() == Qt::Key_F3 || event->key() == Qt::Key_F4 || event->key() == Qt::Key_F5 || event->key() == Qt::Key_F6 || event->key() == Qt::Key_F7 || event->key() == Qt::Key_F8 || event->key() == Qt::Key_F9 || event->key() == Qt::Key_F10 || event->key() == Qt::Key_F11 || event->key() == Qt::Key_F12) return true;
	else return false;
}
	...
	if(table){
		...
		if(dialog.exec() == QDialog::Accepted){
			...
			if(hSplit > 1){
				...
				else current_table.split_merged_cell_by_horisontal(cellColCursor, cellRowCursor);
			}
		...
		for(auto it = currentBlock.begin(); !(it.atEnd()); ++it){
			...
			if(fragment.isValid())
				if(fragment.charFormat().isImageFormat()){
					...
					if((fragmentStart == selectionStart && fragmentEnd == selectionEnd) || (fragmentStart == selectionEnd && fragmentEnd == selectionStart)){
...
void Editor::edit_image_properties(void){
	...
	if(imageFormat.isValid()){
		...
		if(is_cursor_on_image()){
			...
			if(_text_area->textCursor().atBlockStart()) helper.movePosition(QTextCursor::NextCharacter, QTextCursor::KeepAnchor);
			else helper.movePosition(QTextCursor::PreviousCharacter, QTextCursor::KeepAnchor);
			helper.setCharFormat(imageFormat);
		}
	}
}
...
void Editor::dir_file_empty_reaction(int mode){
	...
	if(mode == DIRFILEEMPTY_REACTION_SHOW_ERROR || mode == DIRFILEEMPTY_REACTION_SUPPRESS_ERROR) _dir_file_empty_reaction = mode;
