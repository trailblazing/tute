...
void Editor::setup_buttons(void){
	...
	_font_size = add_action(_tools_line_1, this, tr((editor_prefix + "fontsize").c_str()), tr("Select font size"), tr("Select font size"), QIcon(), (FlatComboBox *) (nullptr), this, &Editor::on_fontsize_changed);
...
void Editor::assembly(void){
	...
	full_layout->addLayout(text_layout);//addWidget(_text_area);// reconfiged by MetaEditor::assembly
