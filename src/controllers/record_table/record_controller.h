...
public:
	...
	rctrl_t(EditingWindow *editing_window_, browser::TabWidget *_tabmanager, rs_t *_record_screen, wn_t *_main_window);
	virtual ~rctrl_t();
	...
	//	template<typename return_type, typename parameter_type>  std::function<return_type(const parameter_type &)> index_object;
...
template <>
pos_proxy rctrl_t::index<pos_proxy>(const boost::intrusive_ptr<TreeItem> &) const;
...
template <>
pos_source rctrl_t::index<pos_source>(const boost::intrusive_ptr<TreeItem> &) const;
...
template <>
index_proxy rctrl_t::index<index_proxy>(const boost::intrusive_ptr<TreeItem> &) const;
...
template <>
index_source rctrl_t::index<index_source>(const boost::intrusive_ptr<TreeItem> &) const;
...
template <>
id_value rctrl_t::index<id_value>(const boost::intrusive_ptr<TreeItem> &) const;

template <>
boost::intrusive_ptr<TreeItem> rctrl_t::index<boost::intrusive_ptr<TreeItem> >(const pos_source &) const;
template <>
boost::intrusive_ptr<TreeItem> rctrl_t::index<boost::intrusive_ptr<TreeItem> >(const index_proxy &) const;
template <>
boost::intrusive_ptr<TreeItem> rctrl_t::index<boost::intrusive_ptr<TreeItem> >(const pos_proxy &) const;
template <>
boost::intrusive_ptr<TreeItem> rctrl_t::index<boost::intrusive_ptr<TreeItem> >(const index_source &) const;
template <>
boost::intrusive_ptr<TreeItem> rctrl_t::index<boost::intrusive_ptr<TreeItem> >(const id_value &) const;
