...
protected:
    ...
    boost::intrusive_ptr<i_t> synchronize(boost::intrusive_ptr<RecordIndex> record_index_);
...
template <>
index_proxy rctrl_t::index<index_proxy>(const boost::intrusive_ptr<i_t>&) const;
...
template <>
index_source rctrl_t::index<index_source>(const boost::intrusive_ptr<i_t>&) const;
...
template <>
boost::intrusive_ptr<i_t> rctrl_t::index<boost::intrusive_ptr<i_t> >(const pos_source&) const;
template <>
boost::intrusive_ptr<i_t> rctrl_t::index<boost::intrusive_ptr<i_t> >(const index_proxy&) const;
template <>
boost::intrusive_ptr<i_t> rctrl_t::index<boost::intrusive_ptr<i_t> >(const pos_proxy&) const;
template <>
boost::intrusive_ptr<i_t> rctrl_t::index<boost::intrusive_ptr<i_t> >(const index_source&) const;
template <>
boost::intrusive_ptr<i_t> rctrl_t::index<boost::intrusive_ptr<i_t> >(const id_value&) const;
