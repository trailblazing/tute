...
//    void hspl_sizelist(QList<int> list);
    ...
    private:
        ...
        template<int version>QStringList parameter_table(bool withEndSignature = true);
...
template<>QStringList AppConfig::	parameter_table<1>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<2>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<3>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<4>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<5>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<6>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<7>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<8>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<9>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<10>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<11>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<12>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<13>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<14>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<15>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<16>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<17>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<18>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<19>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<20>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<21>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<22>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<23>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<24>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<25>(bool withEndSignature);
template<>QStringList AppConfig::	parameter_table<26>(bool withEndSignature);
