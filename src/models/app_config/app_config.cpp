...
{
    qDebug() << "AppConfig::tree_position(QString view_root_id, QStringList current_item_absolute_path) : id\t= " << view_root_id
             << "\tcurrent_item_absolute_path = " << current_item_absolute_path;
