...
//    boost::intrusive_ptr<TreeItem> target_sibling() const;
	...
	static boost::intrusive_ptr<RecordIndex> instance(const std::function<RecordModel *()> &current_model, const index_source &sibling_index, boost::intrusive_ptr<TreeItem>  target_item);
    private:
...
//	boost::intrusive_ptr<TreeItem>  _target_sibling;
	...
	boost::intrusive_ptr<TreeItem>  _target;
};
