...
public:
    ...
    static boost::intrusive_ptr<RecordIndex> instance(const std::function<RecordModel*()>& current_model_, boost::intrusive_ptr<i_t> host_, boost::intrusive_ptr<i_t> sibling_item_ = nullptr);
    ...
    static boost::intrusive_ptr<i_t> synchronize(boost::intrusive_ptr<i_t> host_) noexcept;
