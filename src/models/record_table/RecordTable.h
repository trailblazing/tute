...
public:
    ...
    int insert_new_record(int pos, std::shared_ptr<Record> record, int mode = ADD_NEW_RECORD_AFTER);    // ADD_NEW_RECORD_TO_END
    int shadow_record_lite(int pos, std::shared_ptr<Record> record, int mode = ADD_NEW_RECORD_AFTER);
