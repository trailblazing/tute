...
public:
    //	Record();
    Record(full_field_map field_data_static_map_ = full_field_map());
...
public:
    ...
    typename boost::remove_reference<typename boost::fusion::result_of::at_key<full_field_map, field_key_type>::type>::type field() const; // , typename field_type_switch = typename switch_type<field_type>::type
    //	{
    ...
    template <typename field_key_type>
    void field(const typename boost::remove_reference<typename boost::fusion::result_of::at_key<full_field_map, field_key_type>::type>::type& value); // , typename field_type_switch = typename switch_type<field_type>::type
    //	{
...
protected:
    ...
    full_field_map _field_data_map;
    //	full_field_fusion_tuple _field_data_fusion;
...
private:
    ...
    template <typename field_key_type>
    const typename boost::fusion::result_of::at_key<crypt_field_map const, typename boost::mpl::at<crypt_field_set, field_key_type>::type>::type read_crypt_field() const;

    //    std::function<void(const QString& name, const QString& value)>
    template <typename field_key_type>
    void write_crypt_field(const typename boost::remove_reference<typename boost::fusion::result_of::at_key<crypt_field_map const, typename boost::mpl::at<crypt_field_set, field_key_type>::type>::type>::type& value);
...
private:
    ...
    template <typename field_key_type>
    typename boost::remove_reference<typename boost::fusion::result_of::at_key<natural_field_map, field_key_type>::type>::type natural_field_source() const;
    //	{//QString name
    ...
    //	}
    template <typename field_key_type>
    void natural_field_source(const typename boost::remove_reference<typename boost::fusion::result_of::at_key<natural_field_map, field_key_type>::type>::type& value);
