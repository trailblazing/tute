...
struct TreeIndex
	...
	static boost::intrusive_ptr<i_t> item_require_from_tree_by_url(boost::intrusive_ptr<real_url_t<url_value>> real_find_url_, const insert_strategy& tree_view_insert_strategy_, const equal_url equal_);
