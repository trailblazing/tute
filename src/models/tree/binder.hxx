...
public:
    ...
    typedef _interface<web::WebView*()> bind_interface; // , boost::intrusive_ptr<TreeItem> (TreeItem::*)(web::WebPage *)
    ...
    typedef std::shared_ptr<bind_interface> bind_helper; // , boost::intrusive_ptr<TreeItem> (TreeItem::*)(web::WebPage *)
    ...
    //        typedef std::function<const boost::intrusive_ptr<coupler>(web::WebPage *page)>              page_binder_exist;
    ...
    typedef std::tuple<item_exist, page_exist, binder_exist, binder_exist, binder_self_reference, binder_self_reference
    ...
    typedef std::tuple<std::shared_ptr<item_exist>, std::shared_ptr<page_exist>, std::shared_ptr<binder_exist>, std::shared_ptr<binder_exist>, std::shared_ptr<binder_self_reference>, std::shared_ptr<binder_self_reference>
