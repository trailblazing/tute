...
template<typename receiver_type>struct connect_action<FlatFontComboBox, receiver_type>{
...
template<typename receiver_type>struct connect_action<FlatComboBox, receiver_type>{
...
return_type *add_action(bar_type *bar
		       ...
		       , const QKeySequence &key = QKeySequence (QKeySequence::UnknownKey)){
	//    QAction *
