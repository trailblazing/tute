...
int test_variant()
{
    ...
    std::cout << a << "\n " << b << ".\n There are " << fusion::result_of::size<variant1::types>::type::value << " elements in the variant" << std::endl;
    ...
    std::cout << a2 << "\n " << b2 << ".\n There are " << fusion::result_of::size<variant2::types>::type::value << " elements in the variant" << std::endl;
...
int test_unify()
{
    typedef boost::mpl::insert<boost::mpl::insert<boost::mpl::insert<boost::mpl::set<>, int>::type, float>::type, int*>::type Set;
