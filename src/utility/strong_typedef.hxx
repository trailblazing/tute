#ifndef STRONG_TYPEDEF_HXX
#define STRONG_TYPEDEF_HXX
...
//  See http://www.boost.org/libs/serialization for updates, documentation, and
//  revision history.

// macro used to implement a strong typedef.  strong typedef
// guarentees that two types are distinguised even though the
// share the same underlying implementation.  typedef does not create
// a new type.  BOOST_STRONG_TYPEDEF_EXTENSION(T, D) creates a new type named D
...
#define BOOST_STRONG_TYPEDEF_EXTENSION(T, D)                                \
