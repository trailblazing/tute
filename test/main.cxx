...
//}
#include "main.h"
void foo(sd::intrusive_ptr<test_intrusive>&& _int0)
{

    //    auto _int1 = std::move(sd::intrusive_ptr<test>(new test(1003))); // std::forward<sd::intrusive_ptr<test>>(sd::intrusive_ptr<test>(new test(1003))); //sd::make_intrusive<test>(1003);
...
int main(int argc, char* argv[])
{
    ...
    sd::intrusive_ptr<test_intrusive> _int0(new test_intrusive(1003)); // = sd::intrusive_ptr<test>(new test(1003)); //= nullptr;
